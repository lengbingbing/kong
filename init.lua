...
local outputdata = require "kong.openapi.OutputData"
...
function Kong.balancer()
  ...
  if(ngx.status ==500 ) then
           local jump_url = '/openapi_500_handler'
...
function Kong.fallback_dispose()
    openapi_error_handlers.fallback_dispose()
end



function Kong.outputdata()

    return outputdata.writeCache(ngx)
